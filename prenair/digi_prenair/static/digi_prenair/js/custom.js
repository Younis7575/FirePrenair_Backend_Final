...
function initializeModalComponents() {
    function initTabs() {
     ...
     // ------------------ Related product's Scrolling
     if (document.querySelector('.related-gigs-swiper')) {
      console.log('Related swiper found');
      const relatedSwiper = new Swiper('.related-gigs-swiper', {
          slidesPerView: 'auto',
          spaceBetween: 20,
          navigation: {
      ...
      // Update swiper after modal opens
      setTimeout(() => relatedSwiper.update(), 300);
  }
