    ...
    passwordInput.oninput= function(){
		...
		function poorPasswordStrength(passwordLength, poorPassword, weakPassword, strongPassword){
			if(passwordLength < 8)
			{
			   ...
			   passwordInfo.innerHTML = '<img src="' + icons.angry + '" class="me-2"> Weak. Must contain at least 8 characters';
		...
		function weakPasswordStrength(passwordLength, poorPassword, weakPassword, strongPassword){
			if(passwordLength >= 8 && (poorPassword || weakPassword || strongPassword))
			{
			   ...
			   passwordInfo.innerHTML = '<img src="' + icons.anguish + '" class="me-2"> Average. Must contain at least 1 letter or number';
		   ...
		   if(passwordLength>= 8 && poorPassword && (weakPassword || strongPassword))
			{
			 ...
			 passwordStrength.classList.remove("heavy-active");
			 passwordInfo.innerHTML = '<img src="' + icons.smile + '" class="me-2"> Almost. Must contain special symbol';
		  ...
		  if(passwordLength >= 8 && (poorPassword && weakPassword) && strongPassword)
			{
			 ...
			 passwordInfo.innerHTML = '<img src="' + icons.smile + '" class="me-2"> Awesome! You have a secure password.';
		  ...
		  if(passwordLength1 >= 8 && (poor1Password1 && weak1Password1) && strong1Password1)
			{
			 ...
			 passwordInfo.innerHTML = '<img src="' + icons.anguish + '" class="me-2"> Awesome! You have a secure password.';
